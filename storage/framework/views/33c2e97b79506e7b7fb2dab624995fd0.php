				...
				<td colspan="2">
					<table class="sort">
						<tr>
							...
							<td>цене (<a href="<?php echo e(route('sort_section', ['type' => 'price', 'up' => 1, 'name' => $genre->title])); ?>">возр.</a> | <a href="<?php echo e(route('sort_section', ['type' => 'price', 'up' => 0, 'name' => $genre->title])); ?>">убыв.</a>)
							<td>названию (<a href="<?php echo e(route('sort_section', ['type' => 'name', 'up' => 1, 'name' => $genre->title])); ?>">возр.</a> | <a href="<?php echo e(route('sort_section', ['type' => 'name', 'up' => 0, 'name' => $genre->title])); ?>">убыв.</a>)
						</tr>
					</table>
				</td>
			</tr>
...
<?php endif; ?><?php /**PATH E:\xampp_\htdocs\laraveldz2\resources\views/section.blade.php ENDPATH**/ ?>